...
-- ------------------------------------------------------------
-- 12. List of all cities that appear either as a customer's city
--     OR as a product category name coincidence check
--     (a simple, harmless demo of set operators; replace with any
--     two comparable column sets from your own schema if you add one).
-- Concepts: SET OPERATORS (UNION, EXCEPT, INTERSECT)
-- ------------------------------------------------------------

-- Customers who signed up before 2024 UNION customers who spent > 1000
SELECT customer_id, name FROM retail.customers WHERE signup_date < '2024-01-01'
UNION
...
-- Concepts: SUBQUERY, LEFT JOIN alternative
-- ------------------------------------------------------------
